...
export const EFFECT_SECTION_DEFINITIONS: EffectSectionDefinition[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      {
        type: 'slider',
        presets: ['patternRefraction'],
        label: 'Refraction',
        field: 'patternRefraction',
        min: 0,
        max: 100,
        valueFormat: 'percent',
      },
  ...
  },
  {
    ...
    controls: [
      ...
      { type: 'color', presets: ['gradientMap'], label: 'Shadow', field: 'gradientMapShadow' },
      { type: 'color', presets: ['gradientMap'], label: 'Midtone', field: 'gradientMapMid' },
      { type: 'color', presets: ['gradientMap'], label: 'Highlight', field: 'gradientMapHighlight' },
      {
        type: 'slider',
        presets: ['channelMixer'],
        label: 'Mixer',
        field: 'channelMixer',
        min: 0,
        max: 100,
  ...
  },
  {
    ...
    controls: [
      ...
      {
        type: 'slider',
        presets: ['silhouetteCrush'],
        label: 'Silhouette Crush',
        field: 'silhouetteCrush',
        min: 0,
        max: 100,
        valueFormat: 'percent',
      },
