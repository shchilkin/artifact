...
const EFFECT_SECTION_DEFINITIONS: EffectSectionDefinition[] = [
  {
    ...
    controls: [
      ...
      { type: 'slider', presets: ['fog'], label: 'Fog', field: 'fog', min: 0, max: 100 },
      { type: 'color', presets: ['fog'], label: 'Fog Color', field: 'fogColor' },
      {
        type: 'slider',
        presets: ['speedLines'],
        label: 'Speed Lines',
  ...
  },
  {
    ...
    controls: [
      ...
      { type: 'slider', presets: ['threshold'], label: 'Threshold', field: 'threshold', min: 0, max: 100 },
      { type: 'slider', presets: ['edgeDetect'], label: 'Edge', field: 'edgeDetect', min: 0, max: 100 },
      {
        type: 'slider',
      ...
      { type: 'color', presets: ['gradientOverlay'], label: 'Shadow', field: 'gradA' },
      { type: 'color', presets: ['gradientOverlay'], label: 'Highlight', field: 'gradB' },
      { type: 'slider', presets: ['gradientOverlay'], label: 'Angle', field: 'gradAngle', min: 0, max: 360 },
    ],
  },
];
