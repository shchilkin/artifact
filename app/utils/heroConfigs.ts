...
import { DEFAULT_CONFIG, ALL_EMOJIS } from '../types/config';
...
const BG_COLORS = [
  '#0d0020', '#001008', '#000820', '#140800', '#1a0010',
  '#060606', '#030800', '#1a0500', '#000508', '#0e0800',
  '#00001a', '#080010', '#001a00', '#1a1000', '#000a1a',
];

const RAY_COLORS = [
  '#9900ff', '#00ff88', '#0066ff', '#ff6600', '#ff0080',
  '#aaaaaa', '#88ff00', '#ff4400', '#ff0022', '#ff8800',
  '#00ffcc', '#ff00aa', '#44aaff', '#ffcc00', '#cc00ff',
];

type EffectCombo = Partial<GeneratorConfig>;

const EFFECT_COMBOS: EffectCombo[] = [
...
export function generateRandomHeroFrame(seed: number): HeroFrame {
  ...
  const emojiCount = lerp(3, 5, rand());
  const emojis = pickN(ALL_EMOJIS, emojiCount, rand);
...
export const GENERATED_HERO_SEEDS = [
  111111, 222222, 333333, 444444, 555001,
  666001, 777001, 888001, 999001, 101010,
