...
async function loadFont(): Promise<ArrayBuffer | null> {
  try {
    ...
    const css = await fetch('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@900&display=swap', {
    ...
    >
      ...
      <div
        style={{
          ...
          right: 0,
          bottom: 0,
          background: 'linear-gradient(to top right, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.55) 40%, rgba(0,0,0,0.1) 70%)',
          display: 'flex',
        }}
      />
