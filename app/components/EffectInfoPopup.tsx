...
export function EffectInfoPopup(
    { effectKey, anchorRect, sidebarRight, onMouseEnter, onMouseLeave }: Props,
) {
    ...
    const top = Math.max(
        8,
        Math.min(anchorRect.top - 8, window.innerHeight - 290),
    );
        ...
        >
            <div className="effect-popup__image-wrap">
                {thumbUrl
                    ...
                    : (
                        <div
                            className="effect-popup__image-placeholder"
                            aria-hidden="true"
                        />
                    )}
            </div>
