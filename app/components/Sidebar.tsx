    ...
    <aside className="sidebar" ref={sidebarRef}>
      ...
      {selectedLayer && (
        <div className="sidebar-sections border-t border-border flex-shrink-0 max-h-[60%]">
            ...
            {selectedLayer.kind === 'effect' && (
              <>
                <Section title="LIGHT RAYS" hidden={!showEffectGroup(['rays', 'bloom', 'filmBurn', 'neonGlow'])} onRand={() => randomizeSelectedSection('RAYS')} onReset={() => resetSelectedSection('RAYS')}>
                ...
                <Section title="TEXTURE" hidden={!showEffectGroup(['grain', 'scanlines', 'blur', 'matte', 'dither'])} onRand={() => randomizeSelectedSection('TEXTURE')} onReset={() => resetSelectedSection('TEXTURE')}>
                ...
                <Section title="WARP" hidden={!showEffectGroup(['noiseWarp', 'morph', 'vortex', 'barrel', 'tear', 'mirror', 'wave', 'zoomBlur', 'warp'])} onRand={() => randomizeSelectedSection('WARP')} onReset={() => resetSelectedSection('WARP')}>
                ...
                <Section title="COLOR FX" hidden={!showEffectGroup(['hueShift', 'rgbSplit', 'vignette', 'pixelate', 'posterize', 'threshold', 'edgeDetect', 'gradientOverlay', 'sepia', 'infrared', 'color'])} onRand={() => randomizeSelectedSection('COLORFX')} onReset={() => resetSelectedSection('COLORFX')}>
