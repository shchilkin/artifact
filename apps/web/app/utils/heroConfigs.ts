...
export const GENERATED_HERO_SEEDS = [
  111111, 222222, 333333, 444444, 555001, 666001, 777001, 888001, 999001, 101010, 121212, 131313, 141414, 151515,
  161616, 171717, 181818, 191919, 202020, 212121,
];

export const ALL_HERO_FRAMES: HeroFrame[] = [...HERO_FRAMES, ...GENERATED_HERO_SEEDS.map(generateRandomHeroFrame)];
