export const SHADER_PALETTE_CONTROL_FIELDS = ['palette'] as const;
...
export const SHADER_PRESET_CONTROL_GROUPS = [
  { id: 'colors', title: 'Colors', fields: SHADER_PALETTE_CONTROL_FIELDS },
  ...
  { id: 'composite', title: 'Composite', fields: SHADER_COMPOSITE_CONTROL_FIELDS, role: 'pass-only' },
] as const;
